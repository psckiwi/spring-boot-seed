...
@Component
public class SampleBatch01Job extends CommonBatchJob {

    private final Logger log = LoggerFactory.getLogger(SampleBatch01Job.class);

    private final BatchJobDv jobDv = BatchJobDv.SAMPLE;
    private final BatchJobName jobName = BatchJobName.SAMPLE01;
    ...
    public void exec() {
        ...
        try {
            ...
            jobResult = String.valueOf(number) + " % 2 = " + String.valueOf(number % 2);
        } catch (Exception e) {
